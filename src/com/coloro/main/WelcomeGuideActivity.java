...
public class WelcomeGuideActivity extends Activity {
	...
	private void setListener() {
		...
		mRegister.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Toast.makeText(WelcomeGuideActivity.this, "暂时无法提供此功能", Toast.LENGTH_SHORT).show();
			}
		});
	...
	private void initAnim() {
		mFadeIn = AnimationUtils.loadAnimation(WelcomeGuideActivity.this, R.anim.welcome_guide_welcome_fade_in);
		mFadeIn.setDuration(1000);
		mFadeInScale = AnimationUtils.loadAnimation(WelcomeGuideActivity.this, R.anim.welcome_guide_welcome_fade_in_scale);
		mFadeInScale.setDuration(6000);
		mFadeOut = AnimationUtils.loadAnimation(WelcomeGuideActivity.this, R.anim.welcome_guide_welcome_fade_out);
	...
	private void initPicture() {
		mPicture_1 = getResources().getDrawable(R.drawable.welcome_guide_pic1);
		mPicture_2 = getResources().getDrawable(R.drawable.welcome_guide_pic2);
		mPicture_3 = getResources().getDrawable(R.drawable.welcome_guide_pic3);
	}
